...
function renderSettings(app){
  ...
  list.addEventListener("input", (ev)=>{ const inp = ev.target.closest("input, textarea"); if(!inp) return; const p = cfgLocal.pillars.find(x=>x.id===inp.dataset.id); if(p) p[inp.dataset.field] = inp.value; });
